...
class SignUpPageState extends State<SignUpPage> {
  ...
  final _grandfatherNameFieldKey = GlobalKey();
  final _familyNameFieldKey = GlobalKey();
  ...
  Widget _buildTextFormField({
    ...
    Widget? prefixIcon,
    Widget? suffixIcon, // إضافة متغير suffixIcon
    int? maxLength,
  }) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: suffixIcon, // تمرير suffixIcon
        filled: true,
  ...
  void initState() {
    super.initState();
    // تأجيل تشغيل الدليل التفاعلي حتى يتم بناء الصفحة بالكامل
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Showcase(
                                ...
                                description: 'اضغط هنا لاختيار صورة شخصية. لن تنتقل للخطوة التالية إلا بعد اختيار صورة.',
                                disposeOnTap: false,
                                onTargetClick: () async {
                                  await _scrollTo(_firstNameFieldKey);
                                  ShowCaseWidget.of(context).startShowCase([
                                    _firstNameShowcaseKey,
                                  ]);
                                },
                                ...
                                child: Column(
                                  children: [
                                            ...
                                            children: [
                                              Expanded(
                                                child: Showcase(
                                                  ...
                                                  description: 'ادخل الاسم الأول كما هو في الهوية.',
                                                  disposeOnTap: false,
                                                  onTargetClick: () async {
                                                    await _scrollTo(_fatherNameFieldKey);
                                                    ShowCaseWidget.of(context).startShowCase([
                                                      _fatherNameShowcaseKey,
                                                    ]);
                                                  },
                                              ...
                                              Expanded(
                                                child: Showcase(
                                                  ...
                                                  description: 'ادخل اسم الأب كما هو في الهوية.',
                                                  disposeOnTap: false,
                                                  onTargetClick: () async {
                                                    await _scrollTo(_grandfatherNameFieldKey);
                                                    ShowCaseWidget.of(context).startShowCase([
                                                      _grandfatherNameShowcaseKey,
                                                    ]);
                                                  },
                                                  child: Container(
                                                    key: _fatherNameFieldKey,
                                                    child: _buildTextFormField(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Showcase(
                                                  ...
                                                  description: 'ادخل اسم الجد كما هو في الهوية.',
                                                  disposeOnTap: false,
                                                  onTargetClick: () async {
                                                    await _scrollTo(_familyNameFieldKey);
                                                    ShowCaseWidget.of(context).startShowCase([
                                                      _familyNameShowcaseKey,
                                                    ]);
                                                  },
                                                  child: Container(
                                                    key: _grandfatherNameFieldKey,
                                                    child: _buildTextFormField(
                                              ...
                                              Expanded(
                                                child: Showcase(
                                                  ...
                                                  description: 'ادخل اسم العائلة كما هو في الهوية.',
                                                  disposeOnTap: false,
                                                  onTargetClick: () async {
                                                    await _scrollTo(_idNumberShowcaseKey);
                                                    ShowCaseWidget.of(context).startShowCase([
                                                      _idNumberShowcaseKey,
                                                    ]);
                                                  },
                                                  child: Container(
                                                    key: _familyNameFieldKey,
                                                    child: _buildTextFormField(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Showcase(
                                                  ...
                                                  description: 'ادخل رقم الهوية المكون من 9 أرقام.',
                                                  disposeOnTap: false,
                                                  onTargetClick: () async {
                                                    await _scrollTo(_birthDateFieldKey);
                                                    ShowCaseWidget.of(context).startShowCase([
                                              ...
                                              Expanded(
                                                child: Showcase(
                                                  ...
                                                  description: 'اختر تاريخ ميلادك من هنا.',
                                                  disposeOnTap: false,
                                                  onTargetClick: () async {
                                                    await _scrollTo(_genderFieldKey);
                                                    ShowCaseWidget.of(context).startShowCase([
                                                      _genderShowcaseKey,
                                                    ]);
                                                  },
                                    ...
                                    Showcase(
                                      ...
                                      description: 'اختر الجنس.',
                                      disposeOnTap: false,
                                      onTargetClick: () async {
                                        await _scrollTo(_phoneFieldKey);
                                        ShowCaseWidget.of(context).startShowCase([
                                          _phoneShowcaseKey,
                                        ]);
                                      },
                                    ...
                                    Showcase(
                                      ...
                                      description: 'ادخل رقم الهاتف المكون من 10 أرقام.',
                                      disposeOnTap: false,
                                      onTargetClick: () async {
                                        await _scrollTo(_addressFieldKey);
                                        ShowCaseWidget.of(context).startShowCase([
                                          _addressShowcaseKey,
                                        ]);
                                      },
                                    ...
                                    Showcase(
                                      ...
                                      description: 'ادخل مكان السكن بالتفصيل.',
                                      disposeOnTap: false,
                                      onTargetClick: () async {
                                        await _scrollTo(_emailShowcaseKey);
                                        ShowCaseWidget.of(context).startShowCase([
                                          _emailShowcaseKey,
                                        ]);
                                      },
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Showcase(
                                      ...
                                      description:
                                          'أدخل بريدك الإلكتروني الصحيح لاستلام التنبيهات واسترجاع الحساب',
                                      disposeOnTap: false,
                                      onTargetClick: () async {
                                        await _scrollTo(_passwordShowcaseKey);
                                        ShowCaseWidget.of(context).startShowCase([
                                          _passwordShowcaseKey,
                                        ]);
                                      },
                                    ...
                                    Showcase(
                                      ...
                                      description:
                                          'كلمة المرور يجب أن تكون 6 أحرف على الأقل. استخدم أرقام وحروف لزيادة الأمان.',
                                      child: _buildTextFormField(
                                        ...
                                        suffixIcon: Tooltip(
                                          message: _translate('validation_password_length'),
                                          child: Icon(Icons.help_outline, color: accentColor, size: 20),
                                        ),
                                        validator: (value) {
                                          if (value == null || value.isEmpty) {
                                            return _translate('validation_required');
